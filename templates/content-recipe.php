...
<li <?php rcpm_attr( 'recipe-wrapper', array( 'class' => get_post_class( $classes ) ) ); ?>>
	...
	<?php
	do_action( 'rcpm_before_recipes_loop_item' );
	 ...
	 */
	do_action( 'rcpm_before_recipes_loop_item_title' );
	 ...
	 */
	do_action( 'rcpm_recipes_loop_item_title' );
	 ...
	 *
	 */
	do_action( 'rcpm_after_recipes_loop_item_title' );
	 ...
	 *
	 */
	do_action( 'rcpm_after_recipes_loop_item' );
